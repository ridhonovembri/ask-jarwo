  ...
  <div>
    <Card style="margin: 30px; height: 88vh">
      <template #title>
        ...
        <div style="float: left">
          Ask <del>Jarvis</del> Jarwo <i class="pi pi-prime" style="font-size: 2rem"></i>
        </div>
        <i
          class="pi pi-trash"
    ...
    <div class="footer">      
      <p class="footer-right">
        ...
        ></i>   
        <a href="https://github.com/ridhonovembri/ask-jarwo" target="_blank"> https://github.com/ridhonovembri/ask-jarwo</a>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async ask() {
      ...
      chatHistory.innerHTML += `<div class="bot-message">${marked(result.data.response)}</div>`;
